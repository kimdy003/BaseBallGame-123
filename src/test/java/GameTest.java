...
class GameTest {
    ...
    @Test
    void returnSolvedResultIfTwoStrikes() {
        generateQuestion("456");
        assertMatchedNumber(game.guess("451"), false, 2, 0);
    }

    @Test
    void returnSolvedResultIfTwoBalls() {
        generateQuestion("456");
        assertMatchedNumber(game.guess("654"), false, 1, 2);
    }
